"""
Competitor Changelog Scraper
Extracts fraud/security changes from competitor release notes using LLM
"""
...
class ChangelogScraper:
    ...
    def _get_cached_changes(self, url):
        ...
        try:
            ...
            # Auto-delete cache older than 2 weeks (stale data protection)
    ...
    def fetch_and_extract(self, url, competitor_name, product_name, scrape_mode="keyword_filter"):
        ...
        print(f"  [{product_name}] ({mode_label})")
        ...
        try:
            ...
            truncated = text_content[:max_tokens * 4]  # Rough char estimate (4 chars per token)
